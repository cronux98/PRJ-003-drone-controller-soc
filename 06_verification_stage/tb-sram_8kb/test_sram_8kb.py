"""
cocotb testbench for sram_8kb — Tier A
"""
import sys, os
...
async def test_stress_01(dut):
    ...
    await wb_write_sig(dut, 0x0000, 0x00000001)
    v, ack = await wb_read_sig(dut, 0x0000)
...
async def test_stress_02(dut):
    ...
    await wb_write_sig(dut, 0x0000, 0x00000002)
    v, ack = await wb_read_sig(dut, 0x0000)
    assert ack == 1, f"s2 ack"



# ── Signal-aware WB helpers for sram_8kb ──
CLK = "clk_i"
RST = "rst_ni"
CYCS = "wb_cyc_i"
STBS = "wb_stb_i"
