"""
cocotb testbench for custom_timer — Tier B
"""
import sys, os
...
async def test_stress_05(dut):
    ...
    await wb_write_sig(dut, 0xFF00, 0x00000005)
...
async def test_stress_06(dut):
    ...
    await wb_write_sig(dut, 0xFF04, 0x00000006)
...
async def test_stress_07(dut):
    ...
    await wb_write_sig(dut, 0xFF08, 0x00000007)
...
async def test_stress_08(dut):
    ...
    await wb_write_sig(dut, 0xFF0C, 0x00000008)
...
async def test_stress_09(dut):
    ...
    await wb_write_sig(dut, 0x0000, 0x00000009)
    v, ack = await wb_read_sig(dut, 0x0000)
    assert ack == 1, f"s9 ack"



# ── Signal-aware WB helpers for custom_timer ──
CLK = "wb_clk_i"
RST = "wb_rst_ni"
CYCS = "wb_cyc_i"
STBS = "wb_stb_i"
